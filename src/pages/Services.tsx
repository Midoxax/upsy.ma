      ...
      <section className="container-custom section-spacing">
        <div className="text-center max-w-4xl mx-auto mb-16">
          <h1 className="text-h1 text-foreground mb-6">
            Personalized Guidance that blends clinical depth and performance science.
          </h1>
          <p className="text-h3 text-muted-foreground">
            Every journey is unique — we tailor therapy and performance strategies to help you thrive.
          </p>
        </div>
        ...
        <div className="max-w-3xl mx-auto mb-20">
          <h2 className="text-h2 text-foreground mb-8 text-center">What to Expect</h2>
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-primary via-background to-secondary py-20">
        ...
        <div className="container-custom relative z-10 text-center">
          <h2 className="text-h2 text-white mb-6">
            Performance doesn't stop with individuals — see how U.Psy transforms organizations.
          </h2>
          <Button 
            size="lg" 
            variant="secondary"
